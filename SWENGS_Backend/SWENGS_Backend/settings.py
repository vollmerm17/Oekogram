"""
Django settings for SWENGS_Backend project.
...
SECRET_KEY = '+&m*xl*%xq^b+ejw!d$m79xv@otttf0cfd5#$b&2l4yqqr-ey7'
...
ROOT_URLCONF = 'SWENGS_Backend.urls'
...
WSGI_APPLICATION = 'SWENGS_Backend.wsgi.application'
